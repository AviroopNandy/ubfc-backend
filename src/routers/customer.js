...
router.patch("/customers/:id", async function (req, res) {
    ...
    const allowedUpdates = [ "aadhaarFront", "aadhaarBack", "aadhaarMerged", "aadhaarMasked", "aadhaarLinked", "secondaryID_type", "secondaryID", "dob", "fullname", "care_of", "gender", "avatar", "address", "pan_no", "driving_details", "voter_details", "documents"];
